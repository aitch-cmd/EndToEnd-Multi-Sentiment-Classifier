...
def main():
    try:
        # Load data
        train_df = pd.read_csv(r'D:\projects\testing\data\interim\train_processed.csv')
        test_df = pd.read_csv(r'D:\projects\testing\data\interim\test_processed.csv')
        val_df = pd.read_csv(r'D:\projects\testing\data\interim\validation_processed.csv')
